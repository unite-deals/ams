...
def start():
    ...
    names, rolls, times, l = extract_attendance()
    return render_template('navbar_logout.html', names=names, rolls=rolls, times=times, l=l, totalreg=totalreg(),
                           datetoday2=datetoday2)
...
def add():
    ...
    if totalreg() > 0:
        ...
        return redirect(url_for('index.html', names=names, rolls=rolls, times=times, l=l, totalreg=totalreg(),
                                datetoday2=datetoday2))
